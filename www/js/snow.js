...
function createAsnow()
{
    ...
    snowDiv.style.msAnimationName = 'fade, drop';
    ...
    snowDiv.style.msAnimationDuration = fadeAndDropDuration + ', ' + fadeAndDropDuration;
    ...
    snowDiv.style.msAnimationDelay = snowDelay + ', ' + snowDelay;
